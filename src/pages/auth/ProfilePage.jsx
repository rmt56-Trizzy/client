...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-teal-50 text-slate-700">
      <main className="max-w-6xl mx-auto p-8 space-y-10">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-teal-600 text-transparent bg-clip-text">
              My Trips
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {recommendations.map((trip) => (
              ...
              >
                <div className="flex justify-between items-center p-6 rounded-xl border border-gray-100 bg-white/95 backdrop-blur-sm">
                  <div className="flex items-center gap-5 w-1/3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-50 to-indigo-50 flex items-center justify-center shadow-inner transition-transform duration-300 hover:scale-110">
                      <span className="text-2xl">🗺</span>
                    </div>
                    <div>
                      <span className="font-semibold text-lg bg-gradient-to-r from-slate-700 to-slate-900 text-transparent bg-clip-text">
                        {trip.city}
                      </span>
                  ...
                  <div className="flex-1 text-left">
                    <span className="px-4 py-1.5 rounded-full bg-indigo-50 text-indigo-600 text-sm font-medium">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-indigo-600 text-transparent bg-clip-text">
              Subscription
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {!latestSubscription ? (
              <div className="relative overflow-hidden p-8 rounded-xl border border-indigo-100 bg-gradient-to-r from-indigo-50/50 via-white to-teal-50/50">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-indigo-100 to-teal-100 rounded-full blur-3xl opacity-30 -z-10" />
                <div className="flex justify-between items-center">
                  <div className="space-y-2">
                    <span className="font-semibold text-xl text-slate-800">Enjoy unlimited access</span>
              ...
              <div className="relative overflow-hidden p-8 rounded-xl border border-teal-200 bg-gradient-to-r from-teal-50 to-teal-100/30">
                <div className="absolute top-0 right-0 w-64 h-64 bg-teal-100 rounded-full blur-3xl opacity-30 -z-10" />
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    <span className="font-semibold text-xl text-teal-800">Pro version</span>
                    <p className="text-teal-600">Active subscription</p>
                  </div>
                  
                  <span className="px-4 py-1.5 rounded-full bg-teal-100 text-teal-700 font-medium">

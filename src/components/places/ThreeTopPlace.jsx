export default function ThreeTopPlace() {
  return (
    <div className="relative">
      <div className="absolute top-0 rounded-xl left-0 md:w-full h-full bg-gradient-to-b from-blue-500/45 to-transparent z-10 w-[108px]"></div>
      <img
        ...
        alt="jakarta"
        className="rounded-xl lg:h-[270px] lg:w-[540px] md:h-[190px] md:w-[380px] w-[108px] h-[90px] object-cover"
      />
